---
title: "Objets flous spatialisés: TD"
output:
...
```{r, eval=FALSE}
table[condition de sélection des lignes,]
```
...
11. Calculez, visualisez et commentez le raster **fuzzy_distance**
...
15. Filtrez et exportez la couche, puis visualisez la dans QGIS et commentez le résultat obtenu.
